        ...
        <section className='testimonail-section section-bg section-common pt-100 pb-70' data-aos="fade-up" data-aos-duration="2000">
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-6">
                        <p className="pt-5">Hear directly from our happy patients and their real experiences.From personalized care to lasting results, our patients trust and recommend us.Discover how PRS Dental Care has transformed smiles and built lasting relationships.</p>
                    </div>
                </div>
