        ...
        <section className='service-section pt-100 pb-70' data-aos="fade-up" data-aos-duration="2000">
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-6 col-sm-6">
                        <p className='service-title-text'>Achieve a healthy, confident smile with our expert dental care.From routine check-ups to advanced treatments, we ensure your comfort every step of the way.Let your smile shine with the care it truly deserves.</p>
                    </div>
                </div>
